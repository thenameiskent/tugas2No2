...
class _GajiPegawaiState extends State<GajiPegawai> { 
  ...
  TextEditingController gajiController = TextEditingController();   TextEditingController statusController = TextEditingController();   double bonus = 0.0;   double tunjangan = 0.0; 
  double totalGaji = 0.0; 
 

  void hitungGaji() { 
    double gaji = double.tryParse(gajiController.text) ?? 0.0;     String status = statusController.text.toLowerCase(); 
  ...
  Widget build(BuildContext context) { 
    return Scaffold(       appBar: AppBar( 
      ...
      body: Padding(         padding: const EdgeInsets.all(16.0),         child: Column( 
          mainAxisAlignment: MainAxisAlignment.center,           children: [             TextField( 
            ...
            SizedBox(height: 16.0),             ElevatedButton(               onPressed: () {                 hitungGaji(); 
              }, 
